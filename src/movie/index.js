        ...
        <div className={'wrapper-movie'}>
            ...
            <div className="movie-info" >
                ...
                <div className="movie-title">
                    <h1>{lang ==='ru'? movies.title : movies.original_title}</h1>
                   <div className="about-movie">
                          <button className={'vote-btn'}>{Math.round(movies.vote_average)}.0</button>
                       <div>{country.map((country) =>(
                           <div key={country.iso_3166_1} className={'genres'}>
                              Country: <p>{country.name}</p>
                           </div>
                       ))}</div>
                         <div className={'genres'} > Release date:<p>{movies.release_date}</p></div>
                ...
                <div className={'wr-btn'}>
                    <button className={'btn btn2'}>watch</button>
                </div>
            </div>
