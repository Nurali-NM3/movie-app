       ...
       <footer>
           <div className="link">
               <div className="contact">
                   <div>
                       <a href="/">
                           <svg color={'white'} width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="ipc-icon ipc-icon--tiktok"
                                id="iconContext-tiktok" viewBox="0 0 24 24" fill="currentColor" role="presentation">
                               <path
                                   d="M15.2346 3C15.5316 5.55428 16.9572 7.07713 19.4359 7.23914V10.112C17.9995 10.2524 16.7412 9.78262 15.2778 8.89699V14.2702C15.2778 21.096 7.83633 23.2291 4.84463 18.3365C2.92217 15.1882 4.09941 9.66382 10.2664 9.44241V12.4719C9.7966 12.5475 9.29438 12.6663 8.83536 12.8229C7.46372 13.2873 6.68609 14.1568 6.9021 15.6904C7.31791 18.6281 12.7073 19.4975 12.2591 13.7571V3.0054H15.2346V3Z"></path>
                           </svg>
                       </a>
                   </div>
                   <div>
                       <a href="/">
                           <svg color={'white'} width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                                className="ipc-icon ipc-icon--instagram" id="iconContext-instagram" viewBox="0 0 24 24"
                   ...
                   <div>
                       <a href="/">
                           <svg color={'white'} width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="ipc-icon ipc-icon--twitter"
                                id="iconContext-twitter" viewBox="0 0 24 24" fill="currentColor" role="presentation">
                               <path
                   ...
                   <div>
                       <a href="/">
                           <svg color={'white'} width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="ipc-icon ipc-icon--youtube"
                                id="iconContext-youtube" viewBox="0 0 24 24" fill="currentColor" role="presentation">
                               <path
                   ...
                   <div>
                       <a href="/">
                           <svg color={'white'} width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                                className="ipc-icon ipc-icon--facebook" id="iconContext-facebook" viewBox="0 0 24 24"
                                fill="currentColor" role="presentation">
                               <path
